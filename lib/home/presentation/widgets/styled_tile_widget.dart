...
class StyledTileWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final TemplateTextConfig textConfig in template.texts) {
      ...
      // textbg -> background fill
      // decorationbg -> border color
